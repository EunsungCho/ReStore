...
function getAxiosParmas(productParams: ProductParams) {
...
export const fetchProductsAsync = createAsyncThunk<
  ...
  void,
  { state: RootState }
>("catalog/fetchProductsAsync", async (_, thunckAPI) => {
  const params = getAxiosParmas(thunckAPI.getState().catalog.productParams);
  try {
